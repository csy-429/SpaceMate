...
[고정 라벨 관련]
LABELS는 팀에서 최종 확정했습니다 (2026-07-02, 호스트/청결/접근성/비품/기타).
이후 라벨을 다시 바꿔야 하면 이 리스트 하나만 바꾸면 되고, 나머지 로직(프롬프트 생성,
캐시 저장/로드)은 안 건드려도 됩니다.
...
# 팀 최종 확정 (2026-07-02): 호스트, 청결, 접근성, 비품, 기타
